...
public class Day09_C01_WebTables extends TestBase {
    ...
    public void test() {
        ...
        System.out.println("Otellerin toplam yüksekliği: " + sum);
    ...
    private void tabloSatirSutun(int satir, int sutun){
        System.out.println(satir+" . satir " +sutun+". sutun bilgisi: "+ driver.findElement(By.xpath("//*[@class='tsc_table_s13']//tbody//tr["+satir+"]//td["+sutun+"]")).getText());
    }
